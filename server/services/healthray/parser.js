...
- OBSERVATIONS BLOCK vs SAME-DATE FOLLOW UP — VISIT DATE ANCHOR: The user message may begin with a line "Visit date: YYYY-MM-DD". When present, use it to resolve whether an undated OBSERVATIONS block belongs to the current visit or is a historical baseline:
  • If a "FOLLOW UP ON <date>" block exists where <date> equals the visit date, that block contains the CURRENT VISIT's labs. The undated OBSERVATIONS block is the INITIAL BASELINE from program enrollment (months or years earlier). OMIT ALL labs from the OBSERVATIONS block entirely — do NOT include them in the labs array at all. Use ONLY the labs from the "FOLLOW UP ON <visit-date>" section.
  ...
  • If the note DOES contain "FOLLOW UP ON <date>" sections but NONE of them match the visit date, do NOT use OBSERVATIONS data — skip it entirely and leave those fields empty. The patient likely did not visit on this appointment date; OBSERVATIONS is a historical baseline from a prior enrollment, not this visit.
  ...
  EXAMPLE (match): Visit date: 2026-05-18. Note has undated OBSERVATIONS (FBG-131, HBA1C-7.2, TG-211) and "FOLLOW UP ON 18/5/26" (HBA1C-7, FBG-103, TG-73). Since 18/5/26 == 2026-05-18: OBSERVATIONS labs are OMITTED entirely. Only FOLLOW UP ON 18/5/26 labs are emitted: {test:"HbA1c", value:"7", date:"2026-05-18"}, {test:"FBS", value:"103", date:"2026-05-18"}, {test:"Triglycerides", value:"73", date:"2026-05-18"}.
  EXAMPLE (no match — skip): Visit date: 2026-05-18. Note has "FOLLOW UP ON 20/3/26" and "FOLLOW UP ON 15/4/26" but NO "FOLLOW UP ON 18/5/26". OBSERVATIONS block has FBG-131, HBA1C-7.2, TREATMENT: TAB MED 500MG OD. Since the note has follow-up history but none matches 2026-05-18: OMIT OBSERVATIONS entirely — do NOT extract labs, vitals, or medications from it. Return empty arrays for labs, medications, vitals.
