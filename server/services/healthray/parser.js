...
- OBSERVATIONS BLOCK vs SAME-DATE FOLLOW UP — VISIT DATE ANCHOR: The user message may begin with a line "Visit date: YYYY-MM-DD". When present, use it to resolve whether an undated OBSERVATIONS block belongs to the current visit or is a historical baseline:
  ...
  • If NO "FOLLOW UP ON <date>" block has a date matching the visit date, treat the undated OBSERVATIONS block as the current visit → date: "today".
  ...
  EXAMPLE: Visit date: 2026-05-18. Note has undated OBSERVATIONS (FBG-131, HBA1C-7.2, TG-211) and "FOLLOW UP ON 18/5/26" (HBA1C-7, FBG-103, TG-73). Since 18/5/26 == 2026-05-18: OBSERVATIONS labs are OMITTED entirely — FBG-131, HBA1C-7.2, TG-211 do NOT appear in the labs array. Only FOLLOW UP ON 18/5/26 labs are emitted: {test:"HbA1c", value:"7", date:"2026-05-18"}, {test:"FBS", value:"103", date:"2026-05-18"}, {test:"Triglycerides", value:"73", date:"2026-05-18"}.
- CRITICAL — all dates in these notes are in DD/MM/YYYY format (Indian standard). "06/04/2026" means April 6 2026 → output as 2026-04-06. NEVER interpret as MM/DD/YYYY.`;
