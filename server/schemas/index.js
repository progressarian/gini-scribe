...
export const giniflowVitalsSchema = z.object({
  ...
  bpStandingSys: z.number().int().min(50).max(300).nullish(),
  bpStandingDia: z.number().int().min(20).max(200).nullish(),
  waist: z.number().min(30).max(250).nullish(),
  bodyFat: z.number().min(2).max(75).nullish(),
