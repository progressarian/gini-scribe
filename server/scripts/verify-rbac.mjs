...
const ROUTE_CASES = [
  ...
  ["/api/billing/import/preview", "reception", false],
  ["/api/billing/import/commit", "coordinator", false],
  ["/api/billing/import/errors", "lab", false],
  ["/api/billing/import/history", "consultant", false],
  ["/api/billing/import/commit", "reception_admin", true],
