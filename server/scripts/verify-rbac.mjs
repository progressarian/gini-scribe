...
const ROUTE_CASES = [
  ...
  ["/api/billing/import/sessions/1/decisions", "reception", false],
  ["/api/billing/import/sessions/1/commit", "coordinator", false],
  ["/api/billing/import/sessions/1/failed", "lab", false],
  ["/api/billing/import/history", "consultant", false],
  ["/api/billing/import/sessions/1/commit", "reception_admin", true],
  ["/api/billing/import/history", "admin", true],
  ["/api/billing/import/sessions", "reception", false],
  ["/api/billing/import/sessions", "coordinator", false],
  ["/api/billing/import/sessions", "reception_admin", true],
  ["/api/billing/import/sessions/1/commit", "admin", true],
  ["/api/billing/preview", "reception", true],
  ["/api/billing/preview", "reception_admin", true],
  ["/api/billing/preview", "admin", true],
  ["/api/billing/preview", "coordinator", false],
  ["/api/billing/preview", "lab", false],
  ["/api/billing/preview", "consultant", false],
  ["/api/billing/master/test-rule", "reception_admin", true],
  ["/api/billing/master/test-rule", "admin", true],
  ["/api/billing/master/test-rule", "reception", false],
  ["/api/billing/master/test-rule", "coordinator", false],
  ["/api/billing/master/payment-rules", "reception_admin", true],
  ["/api/billing/master/payment-rules", "admin", true],
  ["/api/billing/master/payment-rules", "reception", false],
  ["/api/billing/master/payment-rules", "coordinator", false],
  ["/api/billing/master/discounts", "reception_admin", true],
  ["/api/billing/master/discounts", "admin", true],
  ["/api/billing/master/discounts", "reception", false],
  ["/api/billing/master/discounts", "coordinator", false],
  ["/api/billing/master/consultant-fees", "reception_admin", true],
  ["/api/billing/master/consultant-fees", "admin", true],
  ["/api/billing/master/consultant-fees", "reception", false],
  ["/api/billing/master/consultant-fees", "coordinator", false],
  ["/api/billing/master/consultant-fees/copy", "reception_admin", true],
  ["/api/billing/master/consultant-fees/copy", "admin", true],
  ["/api/billing/master/consultant-fees/copy", "reception", false],
  ["/api/billing/master/consultant-fees/copy", "coordinator", false],
...
const AUTH_CASES = [
  ...
  ["/api/billing/preview", undefined, 403],
  ["/api/billing/master/test-rule", undefined, 403],
