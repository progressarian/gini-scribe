...
const usePatientStore = create((set, get) => ({
  ...
  savePatient: async () => {
    ...
    const payload = {
      ...
      // "" is meaningful — it clears a lapsed card — so these are sent as-is
      // rather than coalesced to null.
      scheme_code: patient.schemeCode ?? undefined,
      scheme_ref: patient.schemeRef ?? undefined,
    ...
    try {
      ...
      set({
        patient: {
          ...
          abhaId: full.abha_id || "",
          schemeCode: full.scheme_code || "",
          schemeRef: full.scheme_ref || "",
  ...
  loadPatientDB: async (dbRecord, setTab, toast) => {
    set({
      patient: {
        ...
        schemeCode: dbRecord.scheme_code || "",
        schemeRef: dbRecord.scheme_ref || "",
