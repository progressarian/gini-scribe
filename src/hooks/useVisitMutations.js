...
export function useVisitMutations(patientId, refreshData, appointmentId) {
  ...
  const addLab = useCallback(async (data) => {
    try {
  ...
  const addDiagnosis = useCallback(async (data) => {
    try {
  ...
  const updateDiagnosis = useCallback(async (id, data) => {
    try {
  ...
  const stopMedication = useCallback(async (id, data) => {
    try {
