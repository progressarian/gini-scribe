            ...
            <div data-plan-content>
              ...
              <div style={{ border:"1px solid #e2e8f0", borderTop:"none", borderRadius:"0 0 10px 10px", padding:14 }}>
                ...
                {(() => {
                  ...
                  return (
                    <PlanBlock id="extmeds" title={"🏥 Medications by Other Consultants (" + totalExt + ")"} color="#92400e" hidden={planHidden.has("extmeds")} onToggle={()=>toggleBlock("extmeds")}>
                        ...
                        return (
                          <div key={gi} style={{ marginBottom:8 }}>
                            <div style={{ fontSize:10, fontWeight:700, color:"#475569", padding:"3px 8px", background:"#f1f5f9", borderRadius:4, marginBottom:4 }}>
                              {group.doctor}{group.specialty ? " (" + group.specialty + ")" : ""}{group.date ? " \u2014 " + fDate(group.date) : ""}{group.hospital ? " \u2014 " + group.hospital : ""}
                            </div>
