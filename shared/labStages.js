...
export const LAB_RUNGS = [
  ...
  {
    key: "drawing",
    timelineLabel: "Collection started",
    actionNoun: "starting the collection",
    statLabel: "Collecting",
    statSub: "patient at the bench",
    bucket: "drawing",
    filter: "drawing",
    room: LAB_ROOMS.COLLECTION,
    handoff: false,
    ...
    sectionLabel: "🩸 Collecting now — patient at the bench",
    filterLabel: "Collecting",
    pill: "sp-sample",
    pillText: "Collecting",
    timerLabel: "at the bench",
    sinceLabel: "at the bench",
    healthrayAt: null,
    sampleStatuses: ["drawing"],
    advanceTo: "drawing",
    advanceLabel: "▶ Start collection",
    action: "drawing_started",
    floorAction: true,
    actionLabel: "▶ Start collection",
    actionDone: "Collecting",
    actionPast: "Collection started",
    actionHint: "Mark that the patient is at the bench and you are drawing the sample.",
    needsPatient: true,
  },
  {
    key: "collected",
