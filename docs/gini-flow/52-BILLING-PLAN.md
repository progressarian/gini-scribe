...
| **4b**                             | Refunds and credit notes — **designed 2026-09-25** (`52-BILLING-REFUNDS-PLAN.md`, Q14 decided); P4B-02 migration written, being built.                                                                                                                                                                                                                                                             | —                                                                                                                                                                                                                                                                                                                                                       |
...
| --- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- |
| Q14 | **Decided 2026-09-25** — see `52-BILLING-REFUNDS-PLAN.md`: money goes back the way it was paid (an admin may choose another mode, with a reason); the desk asks and a reception_admin or admin approves; a credit note (own `CN` number) covers the whole bill or chosen lines. A paid bill is still never cancelled — it is reversed with a credit note. | Phase 4b, `payments` |
