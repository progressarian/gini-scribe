...
- [ ] **P4B-03 · Credit note service** — `Pending`
- [ ] **P4B-04 · Refund requests: ask and approve** — `Pending`
- [ ] **P4B-05 · Pay out** — `Pending`
- [ ] **P4B-06 · Cash shift includes cash out** — `Pending`
- [ ] **P4B-07 · Test orders on a credit note** — `Pending`
